...
namespace
{
  ...
  namespace x509
  {
    Node parse_and_verify_certificates_decl = bi::Decl
      << (bi::ArgSeq
          << (bi::Arg
              << (bi::Name ^ "certs")
              << (bi::Description ^
      ...
      << (bi::Result
          << (bi::Name ^ "output")
          << (bi::Description ^
              "array of `[valid, certs]`: if the input certificate chain could "
              "be verified then `valid` is `true` and `certs` is an array of "
              "X.509 certificates represented as objects; if the input "
              "certificate chain could not be verified then `valid` is `false "
              "and `certs` is `[]`")
          << (bi::Type
              << (bi::StaticArray
                  << (bi::Type << bi::Boolean)
    ...
    Node parse_and_verify_certificates_with_options_decl = bi::Decl
      << (bi::ArgSeq
          << (bi::Arg
              << (bi::Name ^ "certs")
              << (bi::Description ^
          ...
          << (bi::Arg
              ...
              << (bi::Description ^
                  ...
                  "`MaxConstraintComparisons` and `KeyUsages`. `KeyUsages` is "
                  "list and can have possible values as in: `\"KeyUsageAny\"`, "
    ...
    Node parse_certificate_request_decl =
      bi::Decl << (bi::ArgSeq
                   << (bi::Arg
                       << (bi::Name ^ "csr")
                       << (bi::Description ^
    ...
    Node parse_certificates_decl = bi::Decl
      << (bi::ArgSeq
          << (bi::Arg
              << (bi::Name ^ "certs")
              << (bi::Description ^
    ...
    Node parse_keypair_decl = bi::Decl
      << (bi::ArgSeq
          << (bi::Arg
              << (bi::Name ^ "cert")
              << (bi::Description ^
    ...
    Node parse_rsa_private_key_decl = bi::Decl
      << (bi::ArgSeq
          << (bi::Arg
              << (bi::Name ^ "pem")
              << (bi::Description ^
